...
object PreloadedGameData {
    ...
    val realCashLeaderboard = listOf(
        LeaderboardEntry(1, "JackpotKing_Rick", "👑", "Team Volt Blue", "$48,950.00", 312),
        LeaderboardEntry(2, "QueenOfFeud_Sarah", "💎", "The Wigglebottoms", "$36,400.00", 245),
        LeaderboardEntry(3, "BuzzerGod_Alex", "⚡", "Team Gold Pulse", "$29,120.00", 198),
        LeaderboardEntry(4, "PriceHunter_Sam", "🎯", "The McSillypants", "$21,800.00", 164),
        LeaderboardEntry(5, "DebateMaster_Chloe", "🎙️", "Team Emerald Synths", "$18,450.00", 142),
        LeaderboardEntry(6, "You (Player)", "😎", "The Wigglebottoms", "$1,450.00", 18, isUser = true)
    )
    ...
    val dailyChallenges = listOf(
        DailyChallengeItem("dc_1", "Face-Off Champion", "Win 3 Face-Off buzzers in Family Feud", "$150.00 & 5,000 PTS", 1.0f, "3/3 Completed", isCompleted = true),
        DailyChallengeItem("dc_2", "Price Guru", "Guess within 5% of actual price in The Price Is Right", "$200.00 & 10,000 PTS", 0.7f, "2/3 Items", isCompleted = false),
        DailyChallengeItem("dc_3", "Wheel Master", "Spin and solve at least 2 hidden phrase puzzles", "$350.00 & 15,000 PTS", 0.5f, "1/2 Puzzles", isCompleted = false),
        DailyChallengeItem("dc_4", "Debate Orator", "Submit 5 winning arguments in the Great Debate Arena", "$500.00 & 25,000 PTS", 0.8f, "4/5 Arguments", isCompleted = false),
        DailyChallengeItem("dc_5", "Mob Survivor", "Eliminate at least 50 mob members in 1 vs 100", "$1,000.00 & 50,000 PTS", 0.6f, "30/50 Mob", isCompleted = false)
    )
    ...
    val shopItems = listOf(
        ShopItem("shop_1", "Golden VIP Host Microphone", "Avatar Accessory", "Gives golden animated soundwaves in all team games", "🎙️", 9.99, 15000),
        ShopItem("shop_2", "Crown of Champions", "Avatar Hat", "Sparkling royalty crown visible on stage podiums", "👑", 14.99, 25000),
        ShopItem("shop_3", "5x Bank Multiplier Ticket", "Game Booster", "Multiplies your next win bank by 5x in any match", "⚡", 4.99, 8000),
        ShopItem("shop_4", "Diamond Confetti Cannon", "Victory FX", "Triggers diamond confetti burst upon winning matches", "💎", 7.99, 12000),
        ShopItem("shop_5", "Hilarious Name Customizer Pass", "Game Pass", "Create custom custom family names anytime", "🎲", 2.99, 5000),
        ShopItem("shop_6", "Instant 100k ZynPoints Booster", "Currency Pack", "Adds 100,000 PTS immediately to your account", "🪙", 19.99, null)
    )

    // Daily Spin Wheel Lucrative Rewards (Super High Rewards, Zero Cooldown, Zero Ads)
    val spinRewards = listOf(
        SpinReward("sr_1", "$500 CASH JACKPOT", 500.0, 0, "💰", 0xFF00E676),
        SpinReward("sr_2", "250,000 ZYNPOINTS", 0.0, 250000, "🪙", 0xFFFFD700),
        SpinReward("sr_3", "$250 CASH REWARD", 250.0, 0, "💵", 0xFF00E5FF),
        SpinReward("sr_4", "GOLDEN MYSTERY BOX", 150.0, 100000, "🎁", 0xFFFF4081),
        SpinReward("sr_5", "5X REWARD MULTIPLIER", 100.0, 50000, "⚡", 0xFF7C4DFF),
        SpinReward("sr_6", "$100 CASH PRIZE", 100.0, 0, "✨", 0xFF00B0FF),
